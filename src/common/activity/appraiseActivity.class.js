...
export default class shareWeb {
  constructor(vueComponent, dataSet) {
    ...
    this.DS = dataSet
    this.shareWebAdd = config.SERVERADD() + "/huihome/community/activity/appraiseActivity"
    this.shareWebAdd1 = config.SERVERADD() + "/huihome/community/activity/delAppraiseActivity"
    this.defaultData = {}
  }
