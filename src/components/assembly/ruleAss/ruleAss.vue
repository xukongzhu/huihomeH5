<template>
    <div class="ruleAss">
        <div class="top-user-infor">
            <img v-if="ruleAss.avatar" @click="toRuleDetail(ruleAss.uid,'0','',ruleAss.projid)" :src="ruleAss.avatar" />
...
export default {
    ...
    methods: {
        //跳转角色详情页面
        toRuleDetail: function(uid, roleid, merid, projid) {
            return utils.toRuleDetail(this,uid, roleid, merid, projid)
        },
